#! /bin/bash
# This script generates documentation files for impi, and openmpi from /opt/spack/modulefiles/intel/19.0.5 under the MPIs folder and then updates index.rst
# Example Usage: ./generatempisdocumentation.sh
...
for filename in ${listofmissingfiles[@]}; do 
    ...
    inputfolder="/opt/spack/modulefiles/intel/19.0.5/$filename/"
